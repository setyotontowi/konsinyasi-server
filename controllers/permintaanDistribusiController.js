...
export const getAllPermintaanDistribusi = async (req, res) => {
  try {
    const { page = 1, limit = 20, start_date, end_date, id_master_unit, id_master_unit_tujuan, search, permintaan } = req.query;
    const user = req.user; // from JWT middleware

    // Build filters
    const permintaanDistribusi = permintaan === 'true'? 1 : permintaan === 'false'? 0 : undefined;
    const filters = { start_date, end_date, id_master_unit, id_master_unit_tujuan, search, permintaanDistribusi };
